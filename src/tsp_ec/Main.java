...
public class Main {
	...
	public static void main(String args[]) {
		...
		case "TSP-15":
			optimo = fitnessFunction("1,13,2,15,9,5,7,3,12,14,10,8,6,4,11");
			break;
		case "TSP-100":
			optimo = fitnessFunction(
		...
		while (fitnessFunction(getOptimal()) > optimo) {
			 generaciones++;
			/*
		...
		System.out.println("Óptimo: " + optimo);
	}
